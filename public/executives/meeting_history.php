...
$page_css = "executive-history.css";
$page_js = "executive-history.js";
...
<div class="main-content" id="mainContent">
    <header class="department-header">
        <div style="display:flex;align-items:center;gap:11px;">
            ...
            <div>
                <h2 style="margin:0;display:flex;align-items:center;gap:8px;color:#1e293b;font-size:20px;"><i data-lucide="history" style="width:22px;color:#7c3aed;"></i> ประวัติการประชุมของฉัน</h2>
